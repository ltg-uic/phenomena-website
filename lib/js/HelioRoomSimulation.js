...
//constructor
function HelioRoomSimulation( container_planet_table, container_solar_system, control_windows, control_view_angle, control_system_speed, id )
{
	//references
	...
	this.pt = new HelioRoomPlanetTable( this.model, this.containerPlanetTable, this.idPrefix );
...
HelioRoomSimulation.prototype.getConfig = function()
{
	...
	{
		type: "POST",
		data: { "id": this.id, "action": "get_config" },
		datatype: "xml",
		context: this,
